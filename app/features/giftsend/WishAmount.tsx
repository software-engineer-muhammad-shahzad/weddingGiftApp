         ...
         <div className="flex flex-col    gap-6  px-4 glass-card pt-8 pb-8 md:pb-14 border border-[#5FDA78] rounded-[20px]"
           ...
           {/* amount input */}
                     <div className="relative px-4  ">
                       ...
                       <Input  type="text" placeholder="300.50 £ " containerClassName="border-none" className="text-center   font-semibold text-[50px] py-2  outline-none w-full text-white placeholder:text-white "/>
