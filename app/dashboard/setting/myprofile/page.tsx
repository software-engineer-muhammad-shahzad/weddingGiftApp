...
const page = () => {
  ...
  return (
        ...
        <div className="flex justify-center ">
          <div className="relative flex justify-center border w-30 h-30 border-[#5FDA78] rounded-full">
            ...
            onClick={()=>setIsImageOpen(true)}
              className="absolute bottom-0 cursor-pointer right-2 w-12 h-12 flex justify-center items-center"
              style={{
                borderRadius: '100px',
                border: '0.5px solid #5FDA78',
                background: `
    ...
    `,
            ...
            >
              <Image src="/images/pen-line.png" alt="edit" width={20} height={20} />
            </div>
    ...
    `,
          ...
          >
            ...
            {/* other details */}
            <div className="flex flex-col border-b  border-b-[#F1F1F11A]  py-4 px-4 ">
              <p className="font-normal text-sm text-[#EEEEEE]">Name</p>
              <p className="font-bold text-sm text-[#EEEEEE]">Sana khan</p>
            </div>
            {/* Event date */}
            <div className="flex flex-col border-b  border-b-[#F1F1F11A]  py-4 px-4 ">
              <p className="font-normal text-sm text-[#EEEEEE]">Name</p>
