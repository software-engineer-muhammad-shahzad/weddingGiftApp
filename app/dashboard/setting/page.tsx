        ...
        <div className="min-h-screen overflow-auto w-full max-w-382.5 flex justify-center mx-auto ">
            <div className="w-full bg-[#330065] max-w-200 py-8 border   border-yellow-500  px-6">
                ...
                {isLogoutOpen && (
                    ...
                    >
                        <div
                            className="w-[500px] rounded-t-2xl overflow-hidden  bg-clip-padding"
                            style={{ height: "300px" }}
                            onClick={(e) => e.stopPropagation()}
                        >
                            <div className="bg-[#5FDA78] h-full w-full flex flex-col items-center justify-center py-6 px-4 overflow-hidden">
                                ...
                                <div className="flex gap-2 pb-2 mt-8 ">
                                    <button 
                                        ...
                                        className={`border border-[#330065] px-4 cursor-pointer py-2 h-12 w-20 rounded-[20px] transition-colors ${
                                            activeButton === 'no' 
                                    ...
                                    <button 
                                        ...
                                        className={`border border-[#330065] py-2 h-12 cursor-pointer rounded-[20px] w-20 px-4 transition-colors ${
                                            activeButton === 'yes' 
                                                ? 'bg-[#330065] text-[#5FDA78]' 
                                                : 'text-[#330065] hover:bg-[#330065] hover:text-[#5FDA78]'
                                        }`}
